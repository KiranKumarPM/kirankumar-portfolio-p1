    ...
    <>
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div
          ...
          style={{
            backgroundImage: `
              radial-gradient(800px 400px at 20% 10%, rgba(59,130,246,0.30), transparent),
              radial-gradient(600px 300px at 80% 20%, rgba(168,85,247,0.24), transparent),
              radial-gradient(700px 350px at 50% 80%, rgba(14,165,233,0.24), transparent)
            `,
          }}
        />
      </div>
